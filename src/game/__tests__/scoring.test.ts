...
describe('scoreForCategory', () => {
  ...
  it('scores yahtzee as 50 only when all five dice match', () => {
    expect(scoreForCategory('yahtzee', dice(6, 6, 6, 6, 6))).toBe(50);
    expect(scoreForCategory('yahtzee', dice(6, 6, 6, 6, 5))).toBe(0);
  });
